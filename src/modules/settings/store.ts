...
export const DEFAULT_THEME_ID = "draft-default";
...
const STORE_PATH = "draft-settings.json";
...
// window can listen.
const PREFS_CHANGED_EVENT = "draft://prefs-changed";
...
const KEYS_CHANGED_EVENT = "draft://ai-keys-changed";
